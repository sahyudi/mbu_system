    ...
    <div class="content">
        <div class="panel">
            <div class="content-header no-mg-top">
                ...
                <div class="content-header-title">Laboratorium</div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="content-box">
                        <div class="content-box-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil-alt"></i> Add New Laboratorium</button>
                                </div>
...
<script type="text/javascript">
    var datagrid = $("#datagrid").datagrid({
        url: "<?php echo base_url() . 'laboratorium/data'; ?>",
        primaryField: 'id',
        rowNumber: true,
    ...
    function create_update_form(rowIndex) {
        $.post("<?php echo base_url() . 'laboratorium/form'; ?>", {
            index: rowIndex
        }).done(function(data) {
    ...
    function delete_action(rowIndex) {
        swal({
            ...
            $.post("<?php echo base_url() . 'laboratorium/delete'; ?>", {
                id: row.id
            }).done(function(data) {
                datagrid.reload();
            });
