    ...
    <div class="content">
        <div class="panel">
            <div class="content-header no-mg-top">
                ...
                <div class="content-header-title">Employee</div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="content-box">
                        <div class="content-box-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil-alt"></i> Add New Employee</button>
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($employee as $emp) { ?>
                                        <tr>
                                            ...
                                            <td><?= $emp['alamat'] ?></td>
                                            <td>
                                                <a href="#" data-id="<?= $emp['id']; ?>" data-target="#edit-employee" data-toggle="modal" class="btn-edit"><i class="fa fa-pencil-alt"></i> Edit</a>
                                                <a href="javascript:;" onclick="delete_action(<?= $emp['id'] ?>)"><i class="fa fa-trash-alt"></i> Delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
...
<script type="text/javascript">
    ...
    function create_update_form(rowIndex) {
        $.post("<?php echo base_url() . 'employee/form'; ?>", {
            index: rowIndex
        }).done(function(data) {
