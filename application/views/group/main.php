				...
				<div class="col-md-12">
					<div class="content-box">
						<div class="content-box-header">
							<div class="row">
								<div class="col-md-6">
									<button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil-alt"></i> Add New Group</button>
								</div>
...
<script type="text/javascript">
	...
	function create_update_form(rowIndex) {
		$.post("<?php echo base_url() . 'group/form'; ?>", {
			index: rowIndex
		}).done(function(data) {
	...
	function delete_action(rowIndex) {
		swal({
			...
			$.post("<?php echo base_url() . 'group/delete'; ?>", {
				id: row.id
			}).done(function(data) {
				datagrid.reload();
			});
