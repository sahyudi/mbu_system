    ...
    <div class="content">
        <div class="panel">
            <div class="content-header no-mg-top">
                ...
                <div class="content-header-title">Pengadaan</div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="content-box">
                        <div class="content-box-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <button class="btn btn-primary" onclick="main_routes('create', '')"><i class="fa fa-pencil-alt"></i> Add New Pembelian</button>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered" id="datagrid">
                                ...
                                <tbody>
                                    <?php $no = 1; ?>
                                    <?php foreach ($pasokMaterial as $pm) { ?>
                                        <tr>
                                            <td class="text-center"><?= $no++ ?></td>
                                            <td><?= $pm['no_pembelian'] ?></td>
                                            <td><?= $pm['tgl_beli'] ?></td>
                                            <td><?= $pm['nama_vendor'] ?></td>
                                            <td><?= $pm['kode_barang'] ?></td>
                                            <td><?= $pm['nama_barang'] ?></td>
                                            <td><?= $pm['jumlah_pembelian'] ?></td>
                                            <!-- <td class="text-right">Rp. <?= number_format($pm['harga_unit']) ?></td> -->
                                            <!-- <td><?= $pm['ukuran'] ?></td> -->
                                            <td>
                                                <a href="#" class="btn-edit" data-toggle="modal" data-target="#modal-material" data-id="<?= $pm['id'] ?>"><i class="fa fa-pencil-alt"></i> Edit</a>
                                                <a href="javascript:;" onclick="delete_action(<?= $pm['id'] ?>)"><i class="fa fa-trash-alt"></i> delete</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
...
<script type="text/javascript">
    ...
    function create_update_form(rowIndex) {
        $.post("<?php echo base_url() . 'pengadaan/form'; ?>", {
            index: rowIndex
        }).done(function(data) {
