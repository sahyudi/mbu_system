...
class Laboratorium extends Base_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['title'] = 'Laboratorium';
        $this->data['ruangan'] = $this->db->get('tbl_ruangan')->result_array();
        $this->data['subview'] = 'labor/main';
    ...
    public function form()
    {
        ...
        $this->load->view('labor/form', $data);
    }
